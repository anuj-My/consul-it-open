  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <h2 className="font-bold text-gray-900">ConsulTOpen AI</h2>
      </div>
      ...
      <div className="flex gap-3 mb-4 overflow-x-auto pb-1">
        {QUICK_PROMPTS.map((prompt, i) => (
          <button
            key={i}
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50/50 text-xs text-gray-600 hover:bg-gray-100 hover:border-gray-300 transition-all whitespace-nowrap min-w-fit group"
          >
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 bg-gray-50/50 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400 transition-all"
        />
